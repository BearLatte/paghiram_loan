  ...
  Widget build(BuildContext context) {
    return CommonView(
      ...
      child: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) => Obx(() => Column(children: [
              Container(
                ...
                child: Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                    ...
                    SizedBox(height: 12),
                    Text(
                      controller.productMaxLoanAmount.value,
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                          Text('Loan Amount(PHP)', style: TextStyle(color: HexColor('#FF102729'))),
                          SizedBox(height: 10),
                          Text(controller.canBorrowAmount.value, style: TextStyle(color: HexColor('#FF102729'), fontSize: 24)),
                          SizedBox(height: 16),
                          SliderTheme(
                            ...
                            child: Slider(
                              ...
                              min: 0.0,
                              max: controller.slierMaxValue.value,
                              onChanged: controller.sliderValueChanged,
                              onChangeEnd: controller.sliderValueChangedEnd,
                            ),
                          ),
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(controller.partOfProductMinAmount.value, style: TextStyle(color: HexColor('#FFAAAAAA'), fontSize: 12)),
                                Text(controller.partOfProductMaxAmount.value, style: TextStyle(color: HexColor('#FFAAAAAA'), fontSize: 12)),
                              ],
                            ),
                          )
                        ]),
