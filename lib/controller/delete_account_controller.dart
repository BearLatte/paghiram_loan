                ...
                Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      width: 80,
                      height: 80,
                      child: CommonImage(src: 'asset/icons/lock_icon.png'),
                    ),
                  )
                ])
              ],
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Stack(
                  ...
                  children: [
                    ...
                    Positioned(top: -40, child: Container(width: 80, height: 80, child: CommonImage(src: 'asset/icons/successful_icon.png')))
                  ],
                )
              ]));
        });
